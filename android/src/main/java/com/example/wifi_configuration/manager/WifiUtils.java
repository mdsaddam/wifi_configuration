...
public final class WifiUtils implements WifiConnectorBuilder,
    ...
    private final WifiScanCallback mWifiScanResultsCallback = new WifiScanCallback() {
        ...
        public void onScanResultsReady() {
            ...
            wifiLog("List of Devices: " + scanResultList.size());
            for(ScanResult scanResult : scanResultList){
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    wifiLog(scanResult.SSID + " - " + scanResult.level + " - " + scanResult.isPasspointNetwork());
                } else {
                    wifiLog(scanResult.SSID + " - " + scanResult.level + " - " + scanResult.capabilities);
                }
            }
